    ...
    <section className="section" style={{ backgroundColor: "var(--color-bg)" }}>
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: "var(--space-14)" }}>
          <h2 style={{ marginBottom: "var(--space-4)", fontSize: "var(--text-4xl)" }}>How Neplance works</h2>
          <p
            ...
            >
              <div
                style={{
                  ...
                  background: "linear-gradient(135deg, var(--color-primary-lightest) 0%, var(--color-primary-100) 100%)",
...
export const TestimonialsSection = () => {
  ...
  return (
    ...
    >
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: "var(--space-14)" }}>
          <h2 style={{ marginBottom: "var(--space-4)", fontSize: "var(--text-4xl)" }}>
        ...
        <div className="grid grid-cols-3" style={{ gap: "var(--space-6)" }}>
          {testimonials.map((testimonial) => (
            ...
            >
              ...
              <p
                className="text-secondary"
                style={{ marginBottom: "var(--space-5)", fontStyle: "italic", lineHeight: 1.7 }}
              >
                "{testimonial.content}"
              </p>
              <div
